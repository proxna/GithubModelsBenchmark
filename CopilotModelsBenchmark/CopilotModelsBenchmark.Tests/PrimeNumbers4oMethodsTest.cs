...
{
    public class PrimeNumbers4oMethodsTests
    {
        [Theory]
        ...
        {
            // Act
            int result = PrimeNumbers4oMethods.PrimeNumber4o(position);
        ...
        public void PrimeNumber4o_InvalidInput_ThrowsArgumentException(int invalidPosition)
        {
            ...
            var exception = Assert.Throws<ArgumentException>(() =>
                PrimeNumbers4oMethods.PrimeNumber4o(invalidPosition));

            Assert.Equal("n must be greater than 0", exception.Message);
        }
        ...
        public void PrimeNumber4o_PerformanceTest_CompletesWithinTimeLimit()
        {
            ...
            var task = System.Threading.Tasks.Task.Run(() => PrimeNumbers4oMethods.PrimeNumber4o(position));
